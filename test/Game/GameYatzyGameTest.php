...
class GameYatzyGameTest extends TestCase
{
    ...
    public function testCreateTheYatzyGameClass()
    {
        ...
        $this->assertInstanceOf("\Jeso20\Game\YatzyGame", $controller);
    }
    ...
    public function testAddPlayer()
    {
        ...
        $this->assertInstanceOf("\Jeso20\Game\Player", $players[0]);
        $this->assertInstanceOf("\Jeso20\Game\Computer", $players[1]);
    }
