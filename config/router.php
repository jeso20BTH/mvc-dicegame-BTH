...
$router->addRoute("GET", "/twenty-one", ["\Jeso20\Controller\TwentyOne", "index"]);
$router->addRoute("POST", "/twenty-one", ["\Jeso20\Controller\TwentyOne", "post"]);

$router->addRoute("GET", "/yatzy", ["\Jeso20\Controller\Yatzy", "index"]);
$router->addRoute("POST", "/yatzy", ["\Jeso20\Controller\Yatzy", "post"]);
